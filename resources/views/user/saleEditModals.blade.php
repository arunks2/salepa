		...
		<div class="modal fade" id="saleHeaderEditModal" tabindex="-1" role="dialog" data-backdrop="true" aria-labelledby="editSaleModal" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      {{ Form::open(['route'=>array('sale_edit', $sale->id),'method'=>'post','id'=>'form', 'data-parsley-validate'=>'true']) }}
		      	<div class="widget-content pad20f">
		      		<div class="sales_information">
		      			<div class="field">
		      				<label>Sale Name</label>
		      				<input type="text" class="input-text" placeholder="Sales Name" name="name" placeholder="e.g Arun`s Yard sale" value="{{$sale->name}}" data-parsley-required />
		      			</div>
		      			<div class="field">
		      				<label>Sales Description</label>
		      				<textarea class="textarea" rows="3" name="description" data-parsley-required >{{$sale->description}}</textarea>
		      			</div>
		      			<div class="row">
		      				<div class="col-md-6">
		      					<div class="field">
		      						<label>Start Date</label>
		      						<input type="text" id="starts_on" name="starts_on" class="input-text" value="{{ $sale->starts_on->format('Y-m-d') }}" data-parsley-required >
		      					</div>
		      				</div>
		      				<div class="col-md-6">
		      					<div class="field">
		      						...
		      						<input 
		      							...
		      							id="ends_on" 
		      							name="ends_on" 
		      							value="@if ($sale->ends_on->format('Y')!=='-0001') 
		      			...
		      			<br>
						<input type="radio" id="radio-2" value="0" name="is_private" @if(!$sale->is_private) checked @endif>
						<label for="radio-2" style="margin-left:8px;">Public Sale - visible on our website (more views)</label>
						<br>
						<input type="radio" id="radio-1" value="1" name="is_private" @if($sale->is_private) checked @endif>
		...
		<div class="modal fade" id="salePrivateEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      {{ Form::open(['route'=>array('sale_edit', $sale->id),'method'=>'post','id'=>'form_edit1', 'data-parsley-validate'=>'true']) }}
		      	<div class="widget-content pad20f">
		      		...
		      		<div class="sales_information">			
		      			<div class="field">
							...
							<p>This information is shared only when you approve during a conversation with a buyer.</p>
		      				<input type="text" class="input-text" data-parsley-required name="pvt_address" value="{{$sale->pvt_address}}" />
		      			</div>
		      			<div class="field">
		      				<label>Contact Number</label>
							<p>Please enter you ten digit mobile number with country code. This number will be <strong>verified via SMS</strong>.</p>
		      				<input type="text" class="input-text" data-parsley-required name="pvt_contact_info" value="{{ $sale->pvt_contact_info}}" />
		      			</div>
		      		</div>
                    <br>
                    <div class="center">
		      		...
		      		<div class="sales_information">
		      			...
		      			<div class="field">
							...
							<p>If you want, you can give a public contact number.</p>
		      				<input type="text" class="input-text"  name="contact_info" value="{{$sale->contact_info}}" />
		      			</div>
		      		</div>
                    <br>
                    <div class="center">
