		...
		<div class="fluid sales-table">
			<div class="widget grid12">
				<div class="widget-content pad10">
					@include('user.errorList')
					{{ Form::open(['route'=>'storesale','method'=>'post','id'=>'form','data-parsley-validate'=>'true']) }}
						<div class="create-sale">
							<h4>Basic Info :</h4>
							<div class="sales_information">
								<div class="field">
									<label>Sale Name</label>
									<input type="text" class="input-text" name="name" placeholder="e.g Arun`s Yard sale" data-parsley-required="true" value="{{ old('name') }}" />
								...
								<div class="field">
									...
									<textarea class="textarea" rows="3" name="description" placeholder="Why are you creating this sale?" data-parsley-required="true">{{ old('description') }}</textarea>
								<!-- SLPDO : Do something -->
								</div>
							...
							<div class="sales_information">
								<div class="field">
									...
									<input type="text" data-parsley-required class="input-text" placeholder="e.g. Vasant Vihar, Delhi" name="address" placeholder="" value="{{ old('address') }}" />
								</div>
								<div class="field">
									<label>Contact Number <span>- optional</span></label>
									<p>If you want, you can give a public contact number.</p>
									<input type="tel" class="input-text" placeholder="xxxxxxxxxx" value="{{ old('contact_info') }}" name="contact_info" placeholder="" />
								</div>
							</div>
							<br>
							...
							<div class="sales_information">			
								<div class="field">
									...
									<input type="text" data-parsley-required class="input-text" placeholder="Full Pickup Address" name="pvt_address" placeholder="" value="{{ old('pvt_address') }}" />
								</div>
								<div class="field">
									<label>Contact Number</label>
									<p>Please enter you ten digit mobile number with country code. This number will be <strong>verified via SMS</strong>.</p>
									<input type="text" data-parsley-required data-parsley-phone="3" class="input-text" placeholder="e.g. +919871069987" name="pvt_contact_info" value="{{ old('pvt_address') }}" />
								</div>
							</div>
							<br>
                             <div class="center">
